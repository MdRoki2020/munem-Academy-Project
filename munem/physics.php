...
<section>
    <div class="container">
        <h1 class="tableHeading text-center">Physics</h1>
        ...
        <table class="table table-striped table table-bordered">
            ...
            <?php
            $runQuery=mysqli_query($connect,"SELECT * FROM `physics`");
            ...
            <tr>
                ...
                <td><video width="320" height="176" controls >
                        <source src="physics_videos/<?php echo $row['video']?>" type="video/mp4">
                    </video></td>
