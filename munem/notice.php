        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light ">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav  ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link bg-primary" href="#">Notice <i class="fas fa-flag-checkered"></i></a>
                    </li>
                    <li class="nav-item">
...
<section class="tableSection">
    <div class="container">
        <h1 class="tableHeading">Notice</h1>
        <table class="table table-striped table table-bordered">
            ...
            <?php
            $runQuery=mysqli_query($connect,"SELECT * FROM `notice` ");
